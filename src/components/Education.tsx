    ...
    >
      ...
      >
        ...
        <p className='text-gray-300 leading-relaxed mb-6'>
          ...
          technical and analytical skills. My education has also strengthened my
          adaptability, teamwork, and commitment to lifelong learning.
        </p>
        ...
        <div className='relative pl-4 border-l-2 border-accent/40'>
          ...
          <p className='text-gray-300 leading-relaxed mb-6'>
            ...
            recognized for its strong academic programs and emphasis on ethical,
            human-centered education.
          </p>
        </div>

        <div className='relative pl-4 border-l-2 border-accent/40'>
          <h3 className='text-xl font-semibold text-accentLight'>Languages</h3>
          <p className='text-gray-300 mt-1'>
            Portuguese - <span className='text-gray-400'>Native</span> | English
            - <span className='text-gray-400'>C1</span> | Italian -{' '}
